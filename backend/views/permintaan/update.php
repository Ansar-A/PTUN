...
$this->title = 'Update Permintaan: ' . $model->id_permintaan;
$this->params['breadcrumbs'][] = ['label' => 'Permintaans', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->id_permintaan, 'url' => ['view', 'id_permintaan' => $model->id_permintaan]];
...
<div class="page-body">
    <div class="container-xl">
        <ul class="breadcrumb" style="padding-bottom: 20px;">
            ...
            <li class="active">Update Permintaan</li>
        </ul>
        <div class="card">
            <?= $this->render('_form', [
                'model' => $model,
